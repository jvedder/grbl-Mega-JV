...
//JV #define DEFAULTS_GENERIC
//JV #define CPU_MAP_2560_INITIAL

// To use with RAMPS 1.4 Board, comment out the above defines and uncomment the next two defines
#define DEFAULTS_RAMPS_BOARD  //JV
#define CPU_MAP_2560_RAMPS_BOARD  //JV
...
// NOTE: Defaults are set for a traditional 3-axis CNC machine. Z-axis first to clear, followed by X & Y.
  ...
  //JV #define HOMING_CYCLE_0 (1<<X_AXIS)   // Home X axis
  //JV #define HOMING_CYCLE_1 (1<<Y_AXIS)   // Home Y axis
  //JV #define HOMING_CYCLE_2 (1<<Z_AXIS)   // OPTIONAL: Home Z axis
  #define HOMING_CYCLE_0 (1<<Z_AXIS)                // JV  REQUIRED: First move Z to clear workspace.
  #define HOMING_CYCLE_1 ((1<<X_AXIS)|(1<<Y_AXIS))  // JV  OPTIONAL: Then move X,Y at the same time.
#else
...
#define HOMING_FORCE_SET_ORIGIN // Uncomment to enable. //JV2
